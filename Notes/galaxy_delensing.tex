...
Among currently available surveys, a DES-like galaxy survey can remove about $14\%$ of the lensing signal. Ongoing or recently completed CMB experiments (CMB-S2) will particularly benefit from large scale structure tracers that, once properly combined, will have a better performance than a CMB internal reconstruction.
...
\ee
The lensing component is a significant source of B-modes that, at large scales, corresponds to a white noise source of roughly $5 \mu K$-arcmin independent of the angular scale. This means that it is not only larger than the allowed inflationary component at scales smaller than several degrees ($r_{0.05} < 0.12$ from \cite{bicep2/keck-collaboration:2015}), but it is also comparable to current levels of instrumental noise. 
...
CIB (30\%) &1.44& 1.26  & 1.08\\ \hline
LSS-S2 (42\%) &1.75& 1.42  & 1.11\\ \hline
CMB Planck (7\%) &1.06 & 1.04  & 1.02 \\ \hline
LSS-S2 +CMB (45\%)& 1.81& 1.45& 1.13  \\ \hline
\end{tabular}
\label{tab:current}
\end{table}
%===========================
...
\hline
Surveys &$\alpha_{r=0}, N^{B}_{\ell}=0$& $\alpha_{r=0}$ & $\alpha_{r=0.12}$ \\ \hline \hline
SPTPol (31\%) &1.43& 1.26  & 1.08 \\ \hline
LSS-S2 +SPTPol (55\%) & 2.2 & 1.6 & 1.14  \\ \hline
...
We tested this in the scenario $r=0.12$ where we additionally impose the consistency relation $n_{t}^{\rm{fid}}=-r^{\rm{fid}}/8$. 
...
LSS-S3 (45\%) &1.82& 1.42  & 1.12\\ \hline
CMB 3G (56\%) &2.38& 1.7  & 1.16 \\ \hline
...
\hline
Surveys & $\alpha_{r=0}, N^{B}_{\ell}=0$ & $\alpha_{r=0}$ & $\alpha_{r=0.12}$ \\ \hline \hline
LSST (51\%) &2.0 & 1.9  & 1.7  \\ \hline
LSS-S4  (59\%) &2.5 & 2.3  & 2.3 \\ \hline
SKA (10$\mu$Jy) (53\%) &2.1& 1.9  & 1.16\\ \hline
LSS-S4 + SKA (10$\mu$Jy)  (62\%) &2.6 & 2.3  & 2.5  \\ \hline
CMB S4 (81\%) & 5.0 & 3.7  & 4.2 \\ \hline
