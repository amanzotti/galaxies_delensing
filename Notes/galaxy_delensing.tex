...
For current surveys we only report the improvements in $r$ since the broad beam of the deep BK-like survey does not provide enough leverage to constrain the shape of the B-mode spectra. We still let $n_{t}$ to vary in our fisher calculation even if it is not very degenerate with $r$.
