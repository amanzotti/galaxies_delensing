...
If on the other side we consider an high-resolution ground base experiment the internal lensing reconstruction improves significantly. With an instrumental noise at the expected level for SPTPol the CMB will soon be able to remove an amount of power (35\%) at the level of the CIB. Once combined with LSS tracer this will lead to removing 56\% of the power. 
The improvement of 1.57 in $\sigma(r)$ that will follow even when realistic noise is considered is such that \relook{here}
