...
\caption{Correlation factor $\rho$ with the lensing potential $\kappa$ as a function of the angular scale $\ell$. This figure is the same as \reffig{corrnow} but with a stage-4 CMB experiment performing the internal reconstrcution and with LSST and SKA added to the stage-2 and stage-3 galaxy surveys (LSS-S3). }
\label{fig:corrs4_10}
\end{center}
\end{figure}
%=======
...
\hline
Surveys & $\alpha_{r=0}, N^{B}_{\ell}=0$ & $\alpha_{r=0}$ & $\alpha_{r=0.12}$ \\ \hline \hline
LSST (48\%) &1.84 & 1.76  & 1.74  \\ \hline
LSS-S4  (60\%) &2.47 & 2.31  & \\ \hline
SKA (10$\mu$Jy) (53\%) &2.18& 2.06  & 2.02\\ \hline
SKA (0.1$\mu$Jy) (77\%) &4.6& 3.96  & 3.9\\ \hline
LSS-S4 + SKA (10$\mu$Jy)  (62\%) &2.74 & 2.53  &  \\ \hline
LSS-S4 + SKA (0.1$\mu$Jy)  (80\%) &4.66 & 3.96  &  \\ \hline
CMB S4 (81\%) & 5.16 & 4.32  & 4.2 \\ \hline
