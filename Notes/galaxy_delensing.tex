...
In the following, we sometimes refer to the fraction of lensing B-mode power removed by delensing. This quantity is defined as: $\left< C_{\ell}^{BB,\mathrm{lens}}/C_{{l}}^{BB,\mathrm{res}}\right>_{4<\ell<100}.$
...
It is defined as $\left< \frac{C_{\ell}^{BB,\mathrm{lens}}}{C_{{l}}^{BB,\mathrm{res}}}\right>_{4<\ell<100}.$
\newline
