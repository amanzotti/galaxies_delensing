...
Note however that, as pointed out in in \cite{smith:2012,hirata:2003}, this improves the CMB lensing reconstruction compared to a quadratic estimator approach only for CMB-S4 noise levels. 
...
%\newline
The values in the other columns correspond to ratio of the error before and after delensing for 3 cases: no instrumental noise in the B-mode measurement (but with instrumental noise in the E-mode used to delens) and with instrumental noise for two different values of $r$.}
  \vspace{0.2cm}
