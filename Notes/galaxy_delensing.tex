...
Of course, binning is possible for galaxy surveys, but it is harder for a tracer with poor redshift information like the CIB or radio continuum surveys. 
...
Recently delensing has been performed for the first time on data using both the internal CMB lensing potential reconstruction \cite{carron:2017} as well as CIB maps \cite{larsen:2016a,manzotti:2017} as large scale structure tracers.
