...
An optical survey like DES alone is able to remove $14\%$ of the B-mode lensing power and together with WISE($8\%$) and the CIB ($27\%$) will allow to remove $36\%$ of the power using only LSS survey.
Depending on the CMB instrumental noise and the amount of galactic foreground cleaning, delensing using LSS survey can correspond to an improvement of 30\% in the constrain on the tensor to scalar ratio $r$.
...
For example, delensing with galaxy surveys allows to selectively remove from the CMB only the gravitational effect coming from the non-linear structures in the low-redshift universe. 
