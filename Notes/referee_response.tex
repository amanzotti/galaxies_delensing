...
One information that is probably not clear enough or partially missing in the text is that iterative delensing compared to iterative delensing is important only for CMB-S4 noise levels. For example, the amount of BB power removed for CMB-S3 level using iterative vs. QE is 56\% vs. 58\%. 
