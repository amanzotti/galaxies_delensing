...
Preliminary: CIB performs as an equivalent $\rho_{\text{eff}}$  (correlation coefficient constant over $\ell$) of 0.8. Both D.E.S and DESI are significantly worse, $\rho_{\text{eff}}<0.6$. DESI is slightly better than D.E.S. To delens we need the bulk of the redshift distribution to follow the CMB kernel, having a few outliers at redshift $z>1.5$ is not enough. We also have to keep in mind the results of \citet{smith:2012}, even a perfect LSS survey can not help too much the delensing technique, with the possible exception of futuristic 21 cm.
\end{abstract}
