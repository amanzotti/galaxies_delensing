...
kappakernel_l30_h = np.loadtxt(datadir + 'kappa_kernel_l30_h.txt')
kappakernel_l100_h = np.loadtxt(datadir + 'kappa_kernel_l100_h.txt')
kappakernel_l500_h = np.loadtxt(datadir + 'kappa_kernel_l500_h.txt')
...
# ============================================
# FINALLY SAVE
plt.savefig(image_dir + 'compare_kernel.pdf', dpi=1200, papertype='Letter',
