...
sys.stdout = open('run_test_binning' + datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S"+'.txt'), 'w')
...
multiple_survey_delens.main(labels, cmb)
ells_cmb = np.loadtxt(output_dir + 'cmb_cl/ell.txt')
rho_names = ['rho_des.txt', 'rho_gals.txt', 'rho_comb.txt', 'rho_cmb_' + cmb + '.txt']
...
print(Fore.RED + 'Tracers:' + '-'.join(labels))
multiple_survey_delens.main(labels, cmb)
rho_names = ['rho_desi.txt', 'rho_gals.txt', 'rho_comb.txt', 'rho_cmb_' + cmb + '.txt']
# deep survey to delens or what is giving you E-mode
# deep
deep = {}
deep['noise_uK_arcmin'] = 2.
...
labels = ['des_bin0', 'des_bin1', 'des_bin2', 'des_bin3', 'lsst_bin0', 'lsst_bin1', 'lsst_bin2',
...
multiple_survey_delens.main(labels, cmb)
rho_names = ['rho_desi.txt', 'rho_lsst.txt', 'rho_des.txt', 'rho_gals.txt',
             'rho_comb.txt', 'rho_cmb_' + cmb + '.txt']
...
multiple_survey_delens.main(labels, cmb)
rho_names = ['rho_lsst.txt', 'rho_gals.txt',
             'rho_comb.txt', 'rho_cmb_' + cmb + '.txt']
